...
<div class="wrapper">
    <nav class="navbar navbar-expand-lg navbar-light py-3" id="mainNav">
        <div class="container">
            <a style="margin-left: 6%" class="navbar-brand js-scroll-trigger" href="../index.php">Migration Pro</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../index.php" class="brand-link">
      <img src="../migration.jfif" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
